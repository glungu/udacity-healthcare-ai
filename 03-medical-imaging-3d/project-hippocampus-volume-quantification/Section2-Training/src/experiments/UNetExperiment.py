...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            data = batch['image'].type('torch.FloatTensor').cuda()
            target = batch['seg'].cuda()
            ...
            # ANSWER: Probabilities between 3 prediction classes of each pixel (along dimension 1)
            # Prediction shape: [8, 3, 64, 64], i.e. [batch_size, class_prob, patch_size, patch_size]
